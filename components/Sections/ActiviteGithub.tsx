...
const ActiviteGithub: React.FC<ActiviteGithubProps> = ({ language }) => {
  ...
  // Textes en #151621 et titres en #b8b2b0 pour rester aligné avec le thème.
  const statsThemeParams = "&bg_color=ffffff&title_color=b8b2b0&text_color=151621&icon_color=b8b2b0&hide_border=true&ring_color=b8b2b0";
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {loading ? (
          <div className="flex justify-center py-24">
            <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-t-4 border-b-4 border-[#b8b2b0]"></div>
          </div>
        ) : error ? (
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="bg-white dark:bg-[#151621] p-6 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] shadow-xl hover:-translate-y-2 transition-transform duration-300 flex flex-col h-full group">
              ...
              <div className="w-full overflow-x-auto pb-4 scrollbar-hide">
                ...
                <img
                  src={`https://ghchart.rshah.org/b8b2b0/${GITHUB_USERNAME}`}
            ...
            <div className="flex justify-center mt-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group text-[#151621] dark:text-white flex items-center gap-2 text-sm font-black uppercase tracking-widest hover:text-[#b8b2b0] dark:hover:text-[#b8b2b0] transition-colors"
              >
