...
const AboutSection: React.FC<AboutSectionProps> = ({ language }) => {
  ...
  const languages = [
    { name: language === 'fr' ? 'Français' : 'French', level: 100 },
    { name: language === 'fr' ? 'Anglais' : 'English', level: 60 },
  ];
      ...
      <div className="max-w-5xl mx-auto space-y-16 sm:space-y-24">
        ...
        <div className="scroll-mt-24">
            ...
            {EDUCATION[language].map((edu, idx) => (
              <div key={idx} className="relative pl-8 group">
                ...
                <div className="flex items-start gap-3 mb-2">
                  <div className="p-2 bg-[#b8b2b0]/10 rounded-lg text-[#b8b2b0] opacity-0 group-hover:opacity-100 transition-opacity -ml-2 sm:ml-0">
                    <GraduationCap size={20} />
                  </div>
                  <div>
                    <h3 className="text-lg sm:text-xl font-black text-[#151621] dark:text-white leading-tight">
                      {edu.degree}
                    </h3>
                    <p className="text-[#b8b2b0] font-extrabold uppercase tracking-widest text-xs sm:text-sm mt-1">
                      {edu.school}
                    </p>
                  </div>
                </div>
                ...
                <div className="pl-12">
                  {edu.details && (
                    <p className="text-sm text-[#151621]/60 dark:text-gray-400 font-medium leading-relaxed pl-2 sm:pl-0 border-l-2 border-transparent sm:border-none">
                      {edu.details}
                    </p>
                  )}
                </div>
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12">
              {languages.map((item) => (
                <div key={item.name} className="relative pl-8 group">
                  <div className="absolute left-0 top-1 bottom-1 w-1.5 bg-[#BDC3C7]/30 dark:bg-white/10 rounded-full group-hover:bg-[#b8b2b0] transition-colors duration-500"></div>
                  ...
                  <div className="flex items-start gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <div className="mt-4 h-3 w-full min-w-56 sm:min-w-72 lg:min-w-80 rounded-full bg-[#BDC3C7]/50 dark:bg-white/10 overflow-hidden">
                        <div
                          className="h-full rounded-full bg-[#b8b2b0]"
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-[#151621] dark:bg-white/5 p-8 sm:p-12 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-8 shadow-2xl shadow-[#151621]/10 dark:shadow-none group">
            ...
            <div className="relative z-10 shrink-0">
              ...
              <a
                ...
                className="flex items-center gap-3 px-8 py-4 rounded-full bg-white text-[#151621] hover:bg-[#b8b2b0] hover:text-white transition-all duration-300 font-black uppercase tracking-widest text-sm shadow-xl transform hover:-translate-y-1 cursor-pointer"
              >
                <Layers size={20} />
                {language === 'fr' ? "Voir mes réalisations" : "View My Work"}
                <ArrowRight size={20} />
              </a>
            </div>
          </div>
