...
export const BlobTopRight: React.FC = () => (
  <div className="fixed -top-20 -right-20 w-80 h-80 bg-[#151621] dark:bg-[#b8b2b0]/10 rounded-full opacity-90 dark:opacity-40 blob-animate pointer-events-none z-[-1]">
...
export const BlobBottomLeft: React.FC = () => (
  <div className="fixed -bottom-40 -left-20 w-96 h-96 bg-[#151621] dark:bg-[#b8b2b0]/10 rounded-full opacity-90 dark:opacity-40 blob-animate pointer-events-none z-[-1]" style={{ animationDelay: '2s' }}>
